...
)
{
	...
	printf("MidlDescription.RpcInterfaceInformation: %p\n", MidlDescription.RpcInterfaceInformation);
	printf("ModuleInfo.pModuleBase: %p\n", ModuleInfo.pModuleBase);
...
)
{
	...
	printf("Context.DescriptorAddress: %p\n", Context.DescriptorAddress);
	...
	printf("Context.NumberOfProcedures: %d\n", Context.NumberOfProcedures);
