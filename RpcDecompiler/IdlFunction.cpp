...
DECOMP_STATUS IdlFunction::decodeProcHeader(void* pCtx)
{
	...
	printf("pRpcDecompilerCtxt->pRpcDecompilerInfo->pFormatStringOffsetTable: %p\n", pRpcDecompilerCtxt->pRpcDecompilerInfo->pFormatStringOffsetTable);
	printf("this->m_uProcIdx: %d\n", this->m_uProcIdx);
	printf("uOffsetInProcFmtString: %p\n", uOffsetInProcFmtString);
	printf("pRpcDecompilerCtxt->pRpcDecompilerInfo->pProcFormatString: %p\n", pRpcDecompilerCtxt->pRpcDecompilerInfo->pProcFormatString);
	// Init ProcHeader
